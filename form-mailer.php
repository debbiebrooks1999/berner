...
$TARGET_EMAIL = array($EMAIL_NAME . "@rapport-design\.com$",
										$EMAIL_NAME . "@berner\.co\.uk$");

/* Help: http://www.tectite.com/fmdoc/def_alert.php */
$DEF_ALERT = "kirk@rapport-design.com";
...
$FROM_USER = "accounts@berner.co.uk"; /* the default - setting not used */
...
$FIXED_SENDER = "accounts@berner.co.uk";
...
$LOGDIR = "/var/www/vhosts/devrap.co.uk/logs"; /* directory for log files; empty string to disallow log files */
...
$TEMPLATEDIR = "/var/www/vhosts/devrap.co.uk/berner.devrap.co.uk/form-email-templates/"; /* directory for template files; empty string if you don't have any templates */
...
$FORM_INI_FILE = "/var/www/vhosts/devrap.co.uk/private/form-mailer-berner.ini";
...
$PUT_DATA_IN_URL = false; /* set to true to place data in the URL */
...
$RECAPTCHA_PRIVATE_KEY = "6LeoTfYSAAAAAEbXbtsqchvZ6GezeYU2KPCT8OFt";
...
$ATTACK_DETECTION_URL = "http://berner.devrap.co.uk/spam.php";
...
$ATTACK_DETECTION_REVERSE_CAPTCHA = array("dtk6t9"=>"umbgqc","jca6tg"=>"");
