...
<div class="container">
   <div class=breadcrumb><div>HOME &nbsp;</div>
   <div class=group></div>
  ...
  <div class=row class=header> <div class=side-col> <h1 class=group>BROCHURES</h1> <ul class=menuItems> <!--     <li><span>&nbsp;>&nbsp;</span>sub items</li>   

          <li><span>&nbsp;>&nbsp;</span>sub items</li>    --> </ul> </div> <div class=main-col> <h2 class=group>BROCHURES</h2> <img class=groupImage src=images/group.jpg> <p class=red>Select a subgroup:</p> <ul class=groupItems> <!--
            <li>sub items</li>
            <li>sub items</li>  --> </ul> </div> </div> </div> <!-- <div class=results></div>  --> 


</div>

            <script src=scripts/c35baf9e.vendor.js></script> <!-- Google Analytics: change UA-XXXXX-X to be your site's ID. --> <script>(function(b,o,i,l,e,r){b.GoogleAnalyticsObject=l;b[l]||(b[l]=
      function(){(b[l].q=b[l].q||[]).push(arguments)});b[l].l=+new Date;
      e=o.createElement(i);r=o.getElementsByTagName(i)[0];
      e.src='//www.google-analytics.com/analytics.js';
      r.parentNode.insertBefore(e,r)}(window,document,'script','ga'));
      ga('create','UA-XXXXX-X');ga('send','pageview');</script> <script type=text/javascript>/*
